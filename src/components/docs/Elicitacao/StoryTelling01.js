...
import StoryTelling01V1 from './StoryTelling01V1'


const StoryTelling01 = () => {

  return (
    <div className='content artefact'>
      <HeadArtefact versions={ 'v1' } rastreability={ StoryTelling01V1 }
                    title="Story Telling Com Personas" author= { Members.Esio } />

    <Card>
        <h2>Versionamento</h2>
        <p><Link to='/StoryTelling01V1'>V1</Link></p>
    </Card>
