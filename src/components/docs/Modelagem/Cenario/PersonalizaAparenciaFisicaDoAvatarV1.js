...
const PersonzalizaAparenciaFisicaDoAvatar = () => (
  <div className="content artefact">
    <HeadArtefact versions={ null } rastreability={ null }
                  title="Personzaliza Aparência Física do Avatar V1" author="Pedro Féo"/>
    <Card>
      <h2>Objetivo</h2>
...
export default PersonzalizaAparenciaFisicaDoAvatar