...
const ComprarItensNaLoja = () => (
  <div className="content artefact">
    <HeadArtefact versions={ null } rastreability={ null }
                  title="Comprar itens na Loja" author="Lucas Dutra"/>
    ...
    <Card>
      <h2>Objetivo</h2>
      <p>Comprar qualquer item na <Link to='/Loja'>Loja</Link> utilizando <Link to='/Moeda'>Moedas</Link> ou <Link to='/Gemas'>Gemas</Link></p>
    </Card>

    <Card>
      <h2>Contexto</h2>
      <ul>
        <li>Pré-condição: O usuário deve estar logado, o usuário deve possuir <Link to='/Moeda'>Moedas</Link> ou <Link to='/Gemas'>Gemas</Link></li>
    ...
    <Card>
      ...
      <ul>
        ...
        <li><Link to='/Gemas'>Gemas</Link></li>
...
export default ComprarItensNaLoja