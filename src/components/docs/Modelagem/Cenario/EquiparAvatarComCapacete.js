  ...
  <div className="content artefact">
    ...
    <Card>
      ...
      <ul>
        ...
        <li>Usuário ganha capacete realizando <Link to='/ModelagemLexicos/Tarefa'>tarefas</Link></li>
        <li>Usuário compra <Link to='/ModelagemLexicos/Armário Encantado'>armário encantado</Link> e pode ganhar capacete</li>
