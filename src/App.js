...
const RouteRollUp = props => (
  <Route {...props} onUpdate={() => window.scrollTo(0, 0)} />
);
          ...
          <NavBar>
            <Switch>
              ...
              <RouteRollUp
                exact
                path="/Argumentacoes"
                component={Argumentacao}
              />
              <RouteRollUp
                exact
                path="/Pos-Rastreabilidade"
                component={PosRastreabilidade}
              />
              ...
              <RouteRollUp
                exact
                path="/Entrevista/01"
                component={Entrevista01}
              />
              <RouteRollUp
                exact
                path="/Entrevista/02"
                component={Entrevista02}
              />
              <RouteRollUp exact path="/Etnografia" component={Etnografia} />
              <RouteRollUp
                exact
                path="/Introspeccao"
                component={Introspeccao}
              />
              ...
              <RouteRollUp
                path="/VerificacaoCasoUso"
                component={VerificacaoCasoUso}
              />
              <RouteRollUp
                path="/VerificacaoSuplementarV1"
                component={VerificacaoSuplementarV1}
              />
              <RouteRollUp
                path="/VerificacaoSuplementarV2"
                component={VerificacaoSuplementarV2}
              />
              <RouteRollUp path="/VerificacaoNFR" component={VerificacaoNFR} />
              <RouteRollUp path="/VerificacaoRP" component={VerificacaoRP} />
              <RouteRollUp
                path="/VerificacaoAgil"
                component={VerificacaoAgil}
              />
              <RouteRollUp path="/Validacao" component={Validacao} />
              <RouteRollUp
                path="/VerificacaoLexico"
                component={VerificacaoLexico}
              />
              <RouteRollUp
                path="/VerificacaoCenarios"
                component={VerificacaoCenarios}
              />
                ...
                <Route
                  ...
                  render={() => (
                    <GIFSComponent
                      ...
                      frontEnd={gif.frontEnd}
                      backEnd={gif.backEnd}
                      frontReference={gif.frontReference}
                      backReference={gif.backReference}
                      acceptanceCriteria={gif.acceptanceCriteria}
                    />
                  )}
                />
              ))}
