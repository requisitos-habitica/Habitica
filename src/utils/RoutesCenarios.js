...
const cenarios = {
  "Configurações": {
    color: "pink",
    lexic: {
      "Subir de nível": SubirNivelV1,
      "Enviar gemas": EnviarGemasV1,
      "Enviar mensagem": EnviarMensV1,
      "Aumentar atributo": AumentarAtribV1,
      "Fazer assinatura": fazerAssinV1,
      "Mudar configurações do site": mudarConfgV1,
      "Comprar gema": compGemaV1,
      "Adquirir uma classe": AdquirirClassV1,
      "Morrer": morrerV1,
      "Deletar conta": DelContV1,
      "Fazer uma conta": FazerContV1
    }
  },
  ...
  "Gamificação": {
    color: "Turquoise",
    lexic: {
      "Batalha Chefão": BatalhaChefaoV1,
  ...
  "Inventário": {
    ...
    lexic: {
      ...
      "Equipar Avatar com Armadura": EquiparAvatarComArmaduraV1,
      "Equipar Avatar com Acessório de Cabeça": EquiparAvatarComAcessorioDeCabecaV1,
      "Equipar Avatar com Óculos": EquiparAvatarComOculosV1,
      "Equipar Avatar com Item de Corpo": EquiparAvatarComItemDeCorpoV1,
      "Equipar Avatar com Fundo": EquiparAvatarComFundoV1,
      "Equipar Avatar com Mascote": EquiparAvatarComMascoteV1,
      "Equipar Avatar com Montaria": EquiparAvatarComMontariaV1,
